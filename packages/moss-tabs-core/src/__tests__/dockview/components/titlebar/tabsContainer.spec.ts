...
describe("tabsContainer", () => {
  ...
  test("left actions", () => {
    ...
    let query = cut.element.querySelectorAll(".dv-tabs-and-actions-container > .dv-left-actions-container");
    ...
    query = cut.element.querySelectorAll(".dv-tabs-and-actions-container > .dv-left-actions-container");
    expect(query.length).toBe(1);
    expect(query[0].children.item(0)?.className).toBe("test-left-actions-element");
    ...
    query = cut.element.querySelectorAll(".dv-tabs-and-actions-container > .dv-left-actions-container");
    expect(query.length).toBe(1);
    expect(query[0].children.item(0)?.className).toBe("test-left-actions-element-2");
    expect(query[0].children.length).toBe(1);
  ...
  test("right actions", () => {
    ...
    let query = cut.element.querySelectorAll(".dv-tabs-and-actions-container > .dv-right-actions-container");
    ...
    query = cut.element.querySelectorAll(".dv-tabs-and-actions-container > .dv-right-actions-container");
    expect(query.length).toBe(1);
    expect(query[0].children.item(0)?.className).toBe("test-right-actions-element");
    expect(query[0].children.length).toBe(1);
    ...
    query = cut.element.querySelectorAll(".dv-tabs-and-actions-container > .dv-right-actions-container");
    expect(query.length).toBe(1);
    expect(query[0].children.item(0)?.className).toBe("test-right-actions-element-2");
    expect(query[0].children.length).toBe(1);
