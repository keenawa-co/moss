...
describe("componentFactory", () => {
  describe("createComponent", () => {
    test("valid component and framework component", () => {
      ...
      expect(() => createComponent("id-1", "component-1", { "component-1": mock }, { "component-1": mock2 })).toThrow(
    ...
    test("valid framework component but no factory", () => {
      ...
      expect(() => createComponent("id-1", "component-1", {}, { "component-1": mock })).toThrow(
    ...
    test("valid framework component", () => {
      ...
      const createComponentFn = jest.fn().mockImplementation(() => component);
      ...
      expect(createComponentFn).toHaveBeenCalledWith("id-1", "component-1", frameworkComponent);
    });
    ...
    test("no valid component", () => {
      expect(() => createComponent("id-1", "component-1", {}, {})).toThrow(
    ...
    test("valid component", () => {
      ...
      const componentResult = createComponent("id-1", "component-1", { "component-1": component }, {});
