...
class ClassUnderTest extends BaseGrid<TestPanel> {
  ...
  doRemoveGroup(group: TestPanel, options?: { skipActive?: boolean; skipDispose?: boolean }): TestPanel {
...
describe("baseComponentGridview", () => {
  ...
  test("can add group", () => {
    ...
    const panel1 = new TestPanel("id", document.createElement("div"), 0, 100, 0, 100, LayoutPriority.Normal, false);
    ...
    const panel2 = new TestPanel("id", document.createElement("div"), 0, 100, 0, 100, LayoutPriority.Normal, false);
