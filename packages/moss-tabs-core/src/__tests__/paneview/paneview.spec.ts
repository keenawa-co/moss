...
import { IPaneBodyPart, IPaneHeaderPart, PaneviewPanel } from "../../paneview/paneviewPanel";
...
describe("paneview", () => {
  ...
  test("onDidAddView and onDidRemoveView events", () => {
    ...
    const view1 = new TestPanel("id", "component", "headerComponent", Orientation.VERTICAL, true, true);
    const view2 = new TestPanel("id2", "component", "headerComponent", Orientation.VERTICAL, true, true);
