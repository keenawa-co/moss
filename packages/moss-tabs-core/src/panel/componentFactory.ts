...
export function createComponent<T>(
  ...
  const Component = typeof componentName === "string" ? components[componentName] : undefined;
  const FrameworkComponent = typeof componentName === "string" ? frameworkComponents[componentName] : undefined;
