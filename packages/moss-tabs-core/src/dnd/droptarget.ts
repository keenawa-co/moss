...
export class WillShowOverlayEvent extends DockviewEvent implements DroptargetEvent {
...
export class Droptarget extends CompositeDisposable {
  ...
  readonly onWillShowOverlay: Event<WillShowOverlayEvent> = this._onWillShowOverlay.event;
  ...
  private toggleClasses(quadrant: Position, width: number, height: number): void {
  ...
  private calculateQuadrant(
    ...
    const activationSizeOptions = this.options.overlayModel?.activationSize ?? DEFAULT_ACTIVATION_SIZE;
