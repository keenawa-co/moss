...
export class PanelApiImpl extends CompositeDisposable implements PanelApi {
  ...
  readonly onDidVisibilityChange: Event<VisibilityEvent> = this._onDidVisibilityChange.event;

  readonly _onWillVisibilityChange = new Emitter<VisibilityEvent>();
  readonly onWillVisibilityChange: Event<VisibilityEvent> = this._onWillVisibilityChange.event;

  readonly _onDidActiveChange = new Emitter<ActiveEvent>();
  readonly onDidActiveChange: Event<ActiveEvent> = this._onDidActiveChange.event;
  ...
  readonly onDidParametersChange: Event<Parameters> = this._onDidParametersChange.event;
