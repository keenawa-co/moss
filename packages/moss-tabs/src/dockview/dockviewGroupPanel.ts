...
export class DockviewGroupPanel extends GridviewPanel<DockviewGroupPanelApiImpl> implements IDockviewGroupPanel {
  ...
  constructor(accessor: DockviewComponent, id: string, options: GroupOptions) {
    super(
      ...
      "groupview_default",
      {
        minimumHeight: options.constraints?.minimumHeight ?? MINIMUM_DOCKVIEW_GROUP_PANEL_HEIGHT,
        minimumWidth: options.constraints?.maximumHeight ?? MINIMUM_DOCKVIEW_GROUP_PANEL_WIDTH,
