...
export class DefaultDockviewDeserialzier implements IPanelDeserializer {
  ...
  public fromJSON(panelData: GroupviewPanelState, group: DockviewGroupPanel): IDockviewPanel {
    ...
    const tabComponent = viewData ? viewData.tab?.id : panelData.tabComponent;
