...
describe("dataTransfer", () => {
  describe("getPanelData", () => {
    ...
    test("should retrieve the PanelTransfer object when transfer is active", () => {
      const transferObject = new PanelTransfer("viewId", "groupId", "panelId");
      LocalSelectionTransfer.getInstance<PanelTransfer>().setData([transferObject], PanelTransfer.prototype);
  ...
  describe("getPaneData", () => {
    ...
    test("should retrieve the PaneTransfer object when transfer is active", () => {
      ...
      LocalSelectionTransfer.getInstance<PaneTransfer>().setData([transferObject], PaneTransfer.prototype);
