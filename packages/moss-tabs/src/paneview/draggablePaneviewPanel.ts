...
import { PaneviewDndOverlayEvent, PaneviewUnhandledDragOverEvent } from "./options";
import { IPaneviewComponent } from "./paneviewComponent";
import { IPaneviewPanel, PanePanelInitParameter, PaneviewPanel } from "./paneviewPanel";
...
export abstract class DraggablePaneviewPanel extends PaneviewPanel {
  ...
  private onDrop(event: DroptargetEvent): void {
    ...
    const containerApi = (this._params! as PanePanelInitParameter).containerApi;
