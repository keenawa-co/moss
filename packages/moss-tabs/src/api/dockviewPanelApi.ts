...
export class DockviewPanelApiImpl extends GridviewPanelApiImpl implements DockviewPanelApi {
  ...
  private readonly _onDidLocationChange = new Emitter<DockviewGroupPanelFloatingChangeEvent>();
  readonly onDidLocationChange: Event<DockviewGroupPanelFloatingChangeEvent> = this._onDidLocationChange.event;
  ...
  moveTo(options: DockviewPanelMoveParams): void {
    this.accessor.moveGroupOrPanel({
      ...
      to: {
        ...
        position: options.group ? (options.position ?? "center") : "center",
        index: options.index,
      },
    });
  }
