...
const config: JestConfigWithTsJest = {
  ...
  rootDir: "../../",
  collectCoverageFrom: ["<rootDir>/packages/dockview-core/src/**/*.{js,jsx,ts,tsx}"],
  setupFiles: ["<rootDir>/packages/dockview-core/src/__tests__/__mocks__/resizeObserver.js"],
