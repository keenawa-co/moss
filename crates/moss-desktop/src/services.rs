...
// #[async_trait]
// pub trait AnyService2: Any + Send + Sync {
//     async fn on_event(&self, app_handle: AppHandle, event: ServiceEvent);
//     fn as_any(&self) -> &dyn Any;
// }

// impl dyn AnyService2 {
//     pub fn downcast_arc<T: AnyService2>(self: Arc<Self>) -> Result<Arc<T>, Arc<Self>> {
//         if self.as_any().is::<T>() {
...
//     services: Arc<RwLock<FnvHashMap<TypeId, Arc<dyn AnyService2>>>>,
...
//                                         })
//                                         .collect::<Vec<Arc<dyn AnyService2>>>()
//                                 } else {
//                                     Vec::new()
//                                 }
//                             };
...
//     pub fn get<T: AnyService2>(&self) -> Option<Arc<T>> {
...
//     pub fn get_unchecked<T: AnyService2>(&self) -> Arc<T> {
