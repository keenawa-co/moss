...
const StatusBar = ({ branch }: { branch?: string }) => {
  return (
    <div className="ui-flex ui-w-full ui-items-center ui-px-5 ui-bg-olive-900 ui-text-stone-50 ui-text-xs ">
      <div className="ui-grow">
        <StatusBarButton className="ui-group">
          <svg
            className="ui-opacity-80 group-hover:ui-opacity-100 group-focus:ui-opacity-100 ui-transition"
            ...
            fill="none"
          >
            <g stroke="white" opacity=".8">
              <path strokeLinejoin="round" d="m6 6 2 1.5L6 9" />
              <path strokeLinecap="round" d="M8.4 12h3" />
              <rect width="11" height="11" x="3.5" y="3.5" rx="3.5" />
            </g>
          </svg>
          <span>Console</span>
        </StatusBarButton>
      ...
      {branch && (
        <div>
          <StatusBarButton className="ui-group ui-flex">
            <svg
              className="ui-opacity-80 group-hover:ui-opacity-100 group-focus:ui-opacity-100 ui-transition ui-shrink-0"
              xmlns="http://www.w3.org/2000/svg"
              width="18"
              height="18"
              viewBox="0 0 14 15"
            ...
            <span className="ui-line-clamp-1">{branch}</span>
          </StatusBarButton>
        </div>
      )}
      ...
      <div>
        <StatusBarButton className="ui-group">
          <svg
            className="ui-opacity-80 group-hover:ui-opacity-100 group-focus:ui-opacity-100 ui-w-4.5 ui-h-4.5 ui-transition"
            xmlns="http://www.w3.org/2000/svg"
            width="18"
            height="18"
            viewBox="0 0 14 14"
...
const StatusBarButton = ({ children, className }: ComponentPropsWithoutRef<'button'>) => (
  <button
    className={twMerge(
      'ui-flex  ui-items-center ui-gap-2 ui-grow hover:ui-bg-white hover:ui-bg-opacity-10 focus:ui-bg-white focus:ui-bg-opacity-10 ui-transition ui-px-2.5 ui-py-0.5',
      className
    )}
  >
    {children}
