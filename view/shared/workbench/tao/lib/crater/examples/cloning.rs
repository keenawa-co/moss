//! This example demonstrates using the [ColumnBatch][crater::ColumnBatch] API to efficiently clone
...
//! see https://github.com/Ralith/crater/issues/332 for some pointers on preserving entity allocator
//! state; as of time of writing, you'll need to patch `crater`.

use std::any::TypeId;

use crater::{Archetype, ColumnBatchBuilder, ColumnBatchType, Component, TypeIdMap, TypeInfo, Frame};
...
impl WorldCloner {
    ...
    fn clone_world(&self, world: &Frame) -> Frame {
