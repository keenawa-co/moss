  ...
  return (
    <div className={cn("mr-2.5 flex h-auto items-center space-x-[13px]", className)} {...props}>
      <ControlButton
        ...
        className="size-6 cursor-default rounded-full text-[--moss-color-windowControlsLinux-text] background-[--moss-color-windowControlsLinux-background] hover:background-[--moss-color-windowControlsLinux-hoverBackground] active:background-[--moss-color-windowControlsLinux-activeBackground] dark:bg-[#373737] dark:text-white dark:hover:bg-[#424242] dark:active:bg-[#565656]"
      >
