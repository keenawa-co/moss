...
enum IconState {
  Default = "group-text-[--moss-color-primary]",
  DefaultStroke = "group-stroke-zinc-500",
  Hover = "group-hover:text-[--moss-color-primary]",
  HoverStroke = "group-hover:stroke-zinc-600",
  Active = "text-[--moss-color-primary]",
  Disabled = "text-[--moss-color-primary] bg-opacity-50",
}

export const Sidebar = () => {
  return (
    <aside className="mb-5.5 flex w-full flex-col overflow-auto p-0 background-[--moss-color-sideBar-background]">
      <MenuItem className="bg-zinc-200 group mb-3.5 mt-13">
        ...
        <IconTitle className="text-xs text-[--moss-color-primary]" title={`"Search... ${Math.random().toFixed(3)}"`} />
      ...
      <MenuItem className="group">
        ...
        <IconTitle className="text-sm text-[--moss-color-primary]" title="Settings" />
      </MenuItem>

      <MenuItem className="group">
        <Icon icon="QuickSearch" className={twMerge(IconState.Default, IconState.Hover, "min-w-4")} />
        <IconTitle className="text-sm text-[--moss-color-primary]" title="Quick Search" />
      </MenuItem>
    </aside>
  );
};
