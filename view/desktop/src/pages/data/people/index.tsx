...
export function getPeopleFromPosition({ amount, startIndex }: { amount: number; startIndex: number }): Person[] {
...
export function getData({ columnCount, itemsPerColumn }: { columnCount: number; itemsPerColumn: number }) {
