...
type DropTargetState = IdleState | { type: "is-card-over" } | { type: "is-column-over"; closestEdge: Edge | null };

type DraggableState = IdleState | { type: "generate-column-preview"; container: HTMLElement } | { type: "is-dragging" };
...
export const Column = memo(function Column({ column }: { column: ColumnType }) {
  ...
  return (
    <ColumnContext.Provider value={contextValue}>
      <div
        css={[columnStyles, stateStyles[dropTargetState.type], draggableStateStyles[draggableState.type]]}
        ref={columnRef}
      >
