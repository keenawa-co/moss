...
export function BoardPrototype() {
  ...
  const reorderColumn = useCallback(({ startIndex, finishIndex }: { startIndex: number; finishIndex: number }) => {
    setData((data) => {
      return {
        ...data,
    ...
    ({
      ...
      setData((data) => {
        ...
        const updatedMap = {
          ...
          [startColumnId]: {
            ...sourceColumn,
            items: sourceColumn.items.filter((i) => i.key !== item.key && !registry.selectedCards.includes(i.key)),
          },
          [finishColumnId]: {
            ...destinationColumn,
        ...
        return {
          ...
          lastOperation: {
            ...
            itemIndexInStartColumn,
            itemIndexInFinishColumn:
              typeof itemIndexInFinishColumn === "number" ? itemIndexInFinishColumn : destinationItems.length - 1,
          },
        };
      });
    },
