...
type UseSortableFieldArgs = {
  ...
  isSticky?: boolean;
  onGenerateDragPreview?: (args: { nativeSetDragImage: (image: Element, x: number, y: number) => void }) => void;
...
function shouldHideDropIndicator({ closestEdge, sourceIndex, targetIndex }: ShouldHideDropIndicatorArgs) {
