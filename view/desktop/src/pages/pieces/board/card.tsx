import React, { forwardRef, Fragment, memo, useCallback, useEffect, useRef, useState, type Ref } from "react";
...
const CardPrimitive = forwardRef<HTMLDivElement, CardPrimitiveProps>(function CardPrimitive(
  ...
  return (
    ...
    >
      ...
      <button type="button" className="bg-red-300" onClick={moveToTop}>
        Move To Top
      </button>
      <button type="button" className="bg-olive-300" onClick={moveToBottom}>
        Move To Bottom
      </button>
