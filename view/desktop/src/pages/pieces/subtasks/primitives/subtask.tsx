...
export const Subtask = forwardRef<HTMLDivElement, SubtaskProps>(function Subtask(
  { id, title, appearance = "default", isLastItem = false, children, elemAfter, isIconHidden = false, ...props },
  ref
) {
  return (
    <div
      ref={ref}
      css={[subtaskStyles, subtaskAppearanceStyles[appearance], !isLastItem && subtaskNotLastItemStyles]}
      {...props}
    >
      {children}
      <SubtaskGroup>
