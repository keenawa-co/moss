...
export const SubtaskDragHandle = forwardRef<HTMLButtonElement, SubtaskDragHandleProps>(function SubtaskDragHandle(
  ...
  return (
    <DropdownMenu<HTMLButtonElement>
      trigger={(triggerProps) => (
        <SubtaskDragHandleTrigger {...triggerProps} isHovering={isHovering} isIdle={dragState === "idle"} />
      )}
    >
      <DropdownItemGroup>
