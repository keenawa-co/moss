...
function DraggableField({
  ...
  return (
    <Field ref={ref} isDisabled={isDragging} closestEdge={closestEdge} css={draggableFieldStyles} {...fieldProps}>
      {children}
      <MenuButton
        id={id}
        reorderItem={reorderItem}
      ...
      >
        {({ children, isSelected }) => (
          <span css={[menuButtonContainerStyles, isSelected && menuButtonContainerSelectedStyles]}>{children}</span>
        )}
      </MenuButton>
