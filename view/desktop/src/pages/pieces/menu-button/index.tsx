...
function MenuButtonTrigger({ triggerRef, children, size, isOnlyVisibleWhenFocused, ...props }: MenuButtonTriggerProps) {
  ...
  return children({
    ...
    children: (
      <Button
        ref={triggerRef}
        {...props}
        iconBefore={<MoreIcon spacing="compact" color="currentColor" label="actions" LEGACY_size={size} />}
        spacing={spacing}
