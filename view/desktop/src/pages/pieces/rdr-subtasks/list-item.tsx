      ...
      <Box ref={ref} xcss={listItemContainerStyles}>
        ...
        >
          <Inline space="space.100" alignBlock="center">
            <Grid templateAreas={["stack"]} templateRows="16px" templateColumns="16px" xcss={iconStackStyles}>
              <div
                style={{
              ...
              >
                <DropdownMenu<HTMLButtonElement>
                  trigger={({ triggerRef, ...triggerProps }) => <DragHandleButton ref={triggerRef} {...triggerProps} />}
                >
